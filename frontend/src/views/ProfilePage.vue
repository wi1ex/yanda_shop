<template>
  <div class="profile-page">
    ...
    <div v-if="store.userStore.profileLoading" class="loading-profile">
      Загрузка профиля...
    </div>

    <div v-else-if="store.userStore.profileError" class="error-profile">{{ store.userStore.profileError }}</div>
